/*
Determine minimal GCS Score of the last 24 hours on a hourly base (GCS = Glascow Coma Scale, Trauma Score initially designed for Head injuries)
---------------------------------------------------------------------------------------------------------------------
- MODIFIED VERSION
- SOURCE: https://github.com/alistairewj/sepsis3-mimic/blob/master/query/tbls/gcs-infect-time.sql
...
CREATE FUNCTION get_gcs(int) returns void
    AS 
    $$
with base as
(
  ...
  inner join suspinfect_poe ie  --CHANGED FROM ORIGINAL: added _poe!
...
from suspinfect_poe ie --CHANGED FROM ORIGINAL: added _poe!
