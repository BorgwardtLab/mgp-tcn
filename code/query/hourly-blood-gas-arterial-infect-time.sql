/*
Determine arterial blood gas parameters (PaO2-FiO2) of the last 24 hours on a hourly base
---------------------------------------------------------------------------------------------------------------------
- MODIFIED VERSION
- SOURCES: https://github.com/alistairewj/sepsis3-mimic/blob/master/query/tbls/blood-gas-arterial-infect-time.sql , 
           https://github.com/alistairewj/sepsis3-mimic/blob/master/query/tbls/blood-gas-infect-time.sql 
...
CREATE FUNCTION get_bg(int) returns void
    AS 
    $$
with bloodgas_si as
(
...
( -- begin query that extracts the data
  ...
  -- this also fuses together multiple ITEMIDs containing the same data
    ...
    left join labevents le  --CHANGED FROM ORIGINAL: left join mimiciii.labevents le, as it did not recognize mimiciii.labevents
